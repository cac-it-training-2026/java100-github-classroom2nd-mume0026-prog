...
public class WarehouseManager {
	...
	public static void main(String[] args) {
		...
		int change = 0;
		do {
			for (int i = numberG; i < ABKosanArray1.length; i++) {
				if (ABKosanArray1[i] % 2 == 0) {
					numberG = i;
					break;
				}
			}
			for (int i = numberK; i < ABKosanArray2.length; i++) {
				if (ABKosanArray2[i] % 2 != 0) {
					int temp = ABKosanArray1[numberG];
					ABKosanArray1[numberG] = ABKosanArray2[i];
